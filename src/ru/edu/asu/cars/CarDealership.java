...
public class CarDealership {
	...
	public static void main(String argv[]) throws NoSuchCarException {
		CarDealership dealship = new CarDealership("Авто на Рублёвке");
		SalableCar vaz = new SalableCar("55456165", 2000, 100000 , "Россия", "2107", "Серый", 2015);
		dealship.addCar(vaz);
		SalableCar audi = new SalableCar("78578587", 5000, 10000000 , "Германия", "m3", "Черный", 2012);
